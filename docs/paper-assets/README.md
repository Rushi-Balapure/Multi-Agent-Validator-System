...
The live column above is a development-split score, not the preregistered held-out comparison. Figures and the other formula notes follow the locked experiments in [the implementation plan](../IMPLEMENTATION_PLAN.md). The research scope stays the [two-month research plan](../../Validator_Agent_Two_Month_Research_Plan.pdf).
